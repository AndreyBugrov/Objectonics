# Практическая работа. Разработка программного обеспечения для игры "Объектоника"

## Цель

__Цель данной работы__ — разработать программную систему для стабильной работы интеллектуально-творческой игры "Объектоника".
...
Структура проекта:
  ...
  - `Objectonics` — каталог с основным проектом ЛР.
  - `Objectonics_test` — каталог с проектом с модульными тестами.
  - `README.md` — информация о проекте.
  - `Objectonics.sln` - файл с решением (solution) для Microsoft Visual Studio.
  - Служебные файлы
...
1. Выполнение всех постулатов игры.
2. Предоставление пользователю относительной свободы во внесении изменений в необязательные условия игры.
